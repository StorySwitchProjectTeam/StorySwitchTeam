...
<body>
    ...
    <header class="toolbar">
        ...
        <div class="flex items-center gap-3">
            ...
            <button id="btn-save" class="btn" style="background:#7c3aed; color:white;"><i
                    class="fa-solid fa-floppy-disk"></i> Sauver</button>
    ...
    <script type="module">
        ...
        function loadProject(d) {
            ...
            Object.values(App.nodes).forEach(n => renderNode(n));
            Object.values(App.links).forEach(l => renderLink(l));
            saveState("Load");
        }
        ...
        function loadHist(d) {
            ...
            if (ni >= 0 && ni < App.history.length) {
                ...
                Object.values(App.nodes).forEach(n => renderNode(n)); Object.values(App.links).forEach(l => renderLink(l));
